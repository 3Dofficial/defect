...
function send(){
    ...
    entreDos=Math.floor(word.length/2);
    charAt2=word.charAt(entreDos);
    console.log(charAt2);

    menos1=word.length-1;
    charAt3=word.charAt2(menos1);
    console.log(charAt3);
...
if(answer_turn=="player1"){
    ...
    answer_turn="player1";
    document.getElementById("player_answer").innerHTML="turno para contestar"+player1_name;
}
